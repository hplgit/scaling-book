 ...
 * `sc2.do.txt`: experimental version of `scaling.do.txt` for Sphinx.
   Note that in Ch. 4, half of the mathematics that is rendered
   perfectly in HTML, is not rendered in Sphinx. It's an ongoing project
   to find out why... It seems to be connected to `\bar\boldsymbol{}`.
